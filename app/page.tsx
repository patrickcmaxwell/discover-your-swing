  ...
  return (
    <>
      <section className="relative min-h-[94vh] overflow-hidden px-4 pb-14 pt-28 md:pt-32">
        ...
        <div className="container relative flex min-h-[calc(94vh-8rem)] items-center">
          <div className="max-w-3xl rise" style={{ maxWidth: "min(calc(100vw - 2rem), 43rem)" }}>
      ...
      <section className="section-pad">
        <div className="container grid items-start gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <h2 className="headline mt-3 text-4xl md:text-5xl">Hands-on player development, not one-size-fits-all tips.</h2>
